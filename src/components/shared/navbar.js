...
export default function Navbar() {
  ...
  const logoutUser = () => {
    removeCookie("isAuth");
    successHandler("User logged out successfully!");
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <button
                onClick={() => logoutUser()}
                className="hidden sm:inline-flex ml-5 text-white bg-blue-500 hover:bg-blue-400 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3"
              >
                <svg
